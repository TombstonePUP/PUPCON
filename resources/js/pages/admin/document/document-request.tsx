import { DocumentRequestDataTable } from '@/components/admin/charts/data-table';
import { getRequestsColumns } from '@/components/admin/charts/data-table-columns/requests';
import AppLayout from '@/layouts/admin/app-layout';
import { FilesOverview, type BreadcrumbItem } from '@/types';
import { Head, usePage } from '@inertiajs/react';
import { useCallback } from 'react';

import RenderRequestDialog from '@/components/admin/dialogs/requests/request-dialog-renderer';

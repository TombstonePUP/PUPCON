                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="flex gap-2">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="last_name" onChange={(e) => setData('last_name', e.target.value)} required placeholder={data.last_name} />
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Input id="email" type="email" onChange={(e) => setData('email', e.target.value)} required placeholder={data.email} />

                            ...
                            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                ...
                                >
                                    ...
                                    <p className="text-gray-600">
                                        An official document issued by accrediting bodies that validates an institution's compliance with educational
                                        standards and confirms the authenticity of its academic programs and credentials.
                                    </p>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <p className="text-gray-600">
                                        Provides credibility to graduates, ensures program quality, facilitates credit transfers, and enhances
                                        institutional reputation in the academic and professional community.
                                    </p>
                                </motion.div>
                                ...
                                >
                                    ...
                                    <p className="text-gray-600">
                                        The Certificate of Authenticity will be available once PUP San Juan successfully completes the accreditation
                                        process and receives formal recognition from AACCUP.
                                    </p>
                                </motion.div>
                            </div>
                        </section>
                        ...
                        <section className="contact-section text-center">
                            <div className="rounded-xl border border-[#7f1414]/25 bg-white p-8">
                                ...
                                <p className="mb-6 text-lg text-gray-700">
                                    For updates on our accreditation progress and the availability of the Certificate of Authenticity, please contact
                                    our administration office or visit our website regularly.
                                </p>

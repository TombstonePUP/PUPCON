        ...
        <div className="flex flex-col items-center gap-3">
          <div className="relative mt-7 flex h-[20vw] w-[75%] items-center overflow-hidden rounded-t-2xl rounded-bl-2xl before:absolute before:inset-0 before:bg-gradient-to-r before:from-[#7f1414] before:to-transparent before:content-['']">
            ...
            <div className="absolute right-15 flex h-fit w-fit flex-col gap-[0.8vw] rounded-xl bg-white px-[2vw] py-[1vw] opacity-85">
              <a
                className="border-b border-[##0003] pb-[0.7vw] text-[#a6a6a6] hover:text-[#7f1414] transition duration-300"
                href="#overview"
              >
                Program Overview
              </a>
          ...
          <div
            id="overview"
            className="group flex w-[75%] justify-center gap-4 rounded-xl rounded-tr-none border bg-white border-[#7f1414]/25 p-4 duration-300 hover:border-[#7f1414]"
          >
          ...
          <div className="group flex w-[75%] flex-row justify-between gap-4 rounded-xl">
            <div className="flex-1 rounded-xl border p-8 px-13 duration-300 border-[#7f1414]/25 hover:border-[#7f1414] bg-white">
              <h1 className="mb-4 text-3xl font-bold text-[#7f1414] group-hover:text-[#a01818] transition duration-300">
                Program Overview
              </h1>
          ...
          <div className="w-[75%]" id="goals">
            <div className="grid place-items-center rounded-xl bg-[#7f1414] py-8 text-white mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {programObjectives.map((objective, index) => (
                <div
                  key={objective.id}
                  className="group relative overflow-hidden rounded-xl border border-[#7f1414]/25 bg-white p-8 shadow-lg transition-all duration-300 hover:border-[#7f1414] hover:shadow-xl hover:scale-105"
                >
                  {/* Background Pattern */}
                  <div className="absolute top-0 right-0 w-20 h-20 opacity-5">
                    <div className="text-6xl text-[#7f1414] transform rotate-12">{objective.icon}</div>
                  </div>

                  {/* Objective Number */}
                  <div className="absolute top-4 left-4 flex h-10 w-10 items-center justify-center rounded-full bg-[#7f1414]/10 text-[#7f1414] font-bold transition-colors group-hover:bg-[#7f1414] group-hover:text-white">
                    {index + 1}
                  </div>
            ...
            <div className="mt-8 rounded-xl border border-[#7f1414]/25 bg-white p-6 text-center">
              <h3 className="mb-3 text-lg font-semibold text-[#7f1414]">Our Commitment</h3>
              <p className="text-gray-600">
                These objectives guide our program development and ensure that our graduates are well-prepared to meet
                the challenges of the modern professional landscape while contributing meaningfully to society.
              </p>
            </div>
          </div>

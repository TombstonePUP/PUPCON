...
import { ChevronLeft, ChevronRight, Image as ImageIconComponent, MapPin, Play, SquareArrowOutUpRight, X } from 'lucide-react';
...
const ActionButton = React.memo(
    ({
        ...
        return (
            <Component
                href={href}
                className="inline-flex transform-none items-center justify-center gap-2 rounded-full border-2 border-[#7f1414] bg-[#7f1414] px-4 py-3 text-sm font-semibold text-white transition-all duration-200 hover:scale-101 hover:bg-[#7f1414]/95 active:scale-95 sm:gap-3 sm:px-6 sm:py-4 sm:text-base md:px-8"
                {...externalProps}
                {...props}
            >
            ...
            <Layout>
                                    ...
                                    <div className="h-full cursor-pointer transition-all duration-200" onClick={() => handleOpenNewsDialog(card)}>
                                        <HomeCard className="group flex h-full flex-col overflow-hidden rounded-xl border border-gray-200 bg-white transition-all duration-200">
                                            ...
                                            <CardHeader className="flex flex-1 flex-col p-3 sm:p-4">
                                                ...
                                                <div className="**ease-in-out** my-2 h-px w-full origin-left scale-x-0 bg-[#7f1414] transition-transform duration-300 group-hover:scale-x-100"></div>
                    ...
                    <div className="relative z-10 flex w-[85%] max-w-6xl flex-col items-center justify-center gap-16 lg:flex-row">
                        ...
                        >
                            ...
                            <p className="mb-3 text-base leading-relaxed text-gray-700 sm:mb-4 sm:text-lg lg:text-[1.15rem]">
                                {page?.video_title || 'PUP San Juan Campus AVP 2025'}
                            </p>
                            <p className="mb-6 text-sm text-gray-600 italic sm:mb-8 sm:text-base lg:text-[0.95rem]">
                                {page?.video_description || 'Discover the excellence of our campus through this audio-visual presentation.'}
                            </p>
                ...
                >
                    ...
                    <div className="mx-auto flex w-[80%] max-w-5xl flex-col gap-2 lg:flex-row lg:items-stretch">
                        ...
                        >
                            <SafeImage
                                src={page?.director_image_path || '/images/adfa-new/faculty/Cecilia-Reyes-Alagon.jpg'}
                            ...
                            <div className="scrollbar-thin scrollbar-thumb-white/20 min-h-[140px] overflow-y-auto pr-2">
                                <p className="text-left leading-relaxed">
                                    {page?.director_message ||
                                        'Welcome to PUP San Juan City! As the Campus Director, I am proud to lead a community that values academic excellence, innovation, and service. Our campus is dedicated to providing a nurturing environment where students can thrive and achieve their full potential. We are committed to fostering a culture of inclusivity, creativity, and social responsibility. I invite you to explore our campus, engage with our vibrant community, and join us in our mission to empower the next generation of leaders and change-makers.'}
                                </p>
                            </div>

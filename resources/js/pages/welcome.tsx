            ...
            >
              ...
              <div className="p-6 sm:p-8">
                ...
                <a
                  ...
                  className="mb-4 inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-foreground transition-all duration-200 hover:border-[#7f1414] hover:bg-gray-50 hover:text-[#7f1414] active:scale-95"
                >

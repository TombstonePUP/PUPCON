                                ...
                                <HomeCard className="group w-[18vw] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all hover:-translate-y-1 hover:border-[#7f1414] hover:shadow-lg">
                                    ...
                                    <CardHeader className="p-4">
                                        ...
                                        <HomeCardDescription className="text-sm text-gray-600">
                                            The PUPSJ PUPCET Online Application for Academic Year 2025-2026 starts on December 15, 2024 - April 15,
                                            2025.
                                        </HomeCardDescription>
                                    </CardHeader>
                                </HomeCard>
                                ...
                                <HomeCard className="group w-[18vw] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all hover:-translate-y-1 hover:border-[#7f1414] hover:shadow-lg">
                                    ...
                                    <CardHeader className="p-4">
                                        ...
                                        <HomeCardDescription className="text-sm text-gray-600">
                                            ...
                                            easy-to-follow tips for boosting your well-being.
                                        </HomeCardDescription>
                                    </CardHeader>
                                </HomeCard>
                            </Link>
                            ...
                            <div className="flex flex-1 flex-col gap-4 rounded-xl bg-[#7f1414] p-12 text-white shadow-md">
                                ...
                                <div className="max-h-[120px] overflow-y-auto pr-2">
                                    <p className="text-left leading-relaxed">
                                        ...
                                        collaboration, and excellence. We continue to build a community that uplifts each learner and shapes the
                                        future of education. Maraming salamat sa inyong suporta!
                                    </p>
                                </div>
                                {/* Name & Title */}

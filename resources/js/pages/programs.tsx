...
export default function Programs({ programs }: ProgramsProps) {
  return (
    <>
      ...
      <Layout>
        {/* Hero Banner */}
        <div className="relative h-[30vw] overflow-hidden flex items-center justify-center">
          <img
          ...
          <div className="relative z-10 text-center text-white px-8">
            <h1 className="text-[4vw] font-black mb-4">Programs Under Survey</h1>
            <p className="text-[1.2vw] opacity-90">Discover our comprehensive academic programs</p>
          </div>
        </div>
              ...
              {programs.map((program) => (
                <div key={program.program_id} className="group">
                  <Link href={`/programs/${program.program_name}`} className="block">
                    <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-[#7f1414]/20">

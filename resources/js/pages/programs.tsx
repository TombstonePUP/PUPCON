                                ...
                                {programs.map((program, index) => (
                                    <div key={program.program_id} className="group">
                                        <Link href={`/programs/${program.program_id}`} className="block">
                                            <div className="hover:border-primary/50 relative overflow-hidden rounded-2xl border border-gray-100 bg-white transition-all duration-500">
                                                <div className="md:flex">
                                                    ...
                                                    <div className="relative h-56 overflow-hidden md:h-auto md:w-[280px] md:shrink-0">
                                                        {program.program_image_path ? (
                                                            ...
                                                            <div className="flex h-full w-full flex-col items-center justify-center gap-3 bg-gradient-to-br from-[#7f1414]/8 to-[#7f1414]/3">
                                                                ...
                                                                <span className="text-xs font-medium tracking-widest text-[#7f1414]/30 uppercase">
                                                                    No Image
                                                                </span>
                                                            </div>
                                                        )}
                                                        ...
                                                        <div className="absolute bottom-3 left-3 text-5xl leading-none font-black text-white/20 select-none">
                                                    ...
                                                    <div className="relative flex flex-1 flex-col justify-between p-8 md:p-10">
                                                        ...
                                                        {/* Program name */}
                                                        <div className="mb-4">
                                                            <h2 className="text-2xl leading-snug font-bold text-gray-900 transition-colors duration-200 group-hover:text-[#7f1414] md:text-3xl">
                                                        ...
                                                        <div className="flex items-center justify-between">
                                                            ...
                                                            {/* Arrow CTA */}
                                                            <div className="flex h-9 w-9 items-center justify-center rounded-full border border-[#7f1414]/20 text-[#7f1414] transition-all duration-300 group-hover:border-[#7f1414] group-hover:bg-[#7f1414] group-hover:text-white">
                                                                <svg

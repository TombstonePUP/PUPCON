                ...
                <div className="border-sidebar-border/70 relative space-y-5 overflow-y-auto rounded-xl border p-4">
                    <Accordion type="single" collapsible className='w-[100%] flex flex-col gap-[1vw]'>
                                            ...
                                            <Dialog>
                                                <DialogTrigger asChild>
                                                    <a className='cursor-pointer underline'>
                                                        S.2. The Vision clearly reflects what the Institution hopes to become in the future.                                                    </a>
                                                </DialogTrigger>
                                                <DialogContent>
                                                    <DialogHeader>
                                                        <DialogTitle>Attach Document</DialogTitle>
                                                        <DialogDescription>
                                                            S.2. The Vision clearly reflects what the Institution hopes to become in the future.                                                        </DialogDescription>
                                                    </DialogHeader>
                                                    <div className=" flex flex-col gap-4">
                                                        <div>
                                                            <label className="block text-sm font-medium text-muted-foreground mb-1">Upload Document</label>
                                    ...
                                    <ul className='pl-[1vw]'>
                                        ...
                                        <li>
                                            <Dialog>
                                                <DialogTrigger asChild>
                                                    <a className='cursor-pointer underline'>
                                                        I.1. The Institution/College conducts review on the statement of the Vision and Mission as well as its goals and program objectives for the approval of authorities concerned.
                                                    </a>
                                                </DialogTrigger>
                                                <DialogContent>
                                                    <DialogHeader>
                                            ...
                                            <Dialog>
                                                ...
                                                <DialogContent>
                                                    <DialogHeader>
                                                        <DialogTitle>Add Outline</DialogTitle>
                                                        <DialogDescription>
                                                            Make a new outline for Parameter A - Implementation
                                                        </DialogDescription>
                                                    </DialogHeader>
                                                    <div className=" flex flex-col gap-4">
                                                        <div>
                                            ...
                                            <Dialog>
                                                ...
                                                <DialogContent>
                                                    <DialogHeader>
                                                        <DialogTitle>Add Outline</DialogTitle>
                                                        <DialogDescription>
                                                            Make a new outline for Parameter A - Outcome
                                                        </DialogDescription>
                                                    </DialogHeader>
                                                    <div className=" flex flex-col gap-4">
                                                        <div>
                        ...
                        <AccordionItem value="item-2">
                            <AccordionTrigger className='flex flex-row justify-between items-center'>
                                <div className="flex flex-row justify-between w-full ">
                                    <h1 className='text-[#7f1414] font-black text-lg'>Parameter B</h1>
                                    ...
                                    <Dialog>
                                        ...
                                        <DialogContent>
                                            <DialogHeader>
                                                <DialogTitle>Are you sure?</DialogTitle>
                                                <DialogDescription>
                                                    This action cannot be undone. This will permanently delete the <b>Parameter B</b>.
                                                </DialogDescription>
                                            </DialogHeader>
                                            <DialogFooter>
                                                <DialogClose asChild>
                                            ...
                                            <Dialog>
                                                ...
                                                <DialogContent>
                                                    <DialogHeader>
                                                        <DialogTitle>Add Outline</DialogTitle>
                                                        <DialogDescription>
                                                            Make a new outline for Parameter B - Systems - Inputs and Processes
                                                        </DialogDescription>
                                                    </DialogHeader>
                                                    <div className=" flex flex-col gap-4">
                                                        <div>
                                            ...
                                            <Dialog>
                                                ...
                                                <DialogContent>
                                                    <DialogHeader>
                                                        <DialogTitle>Add Outline</DialogTitle>
                                                        <DialogDescription>
                                                            Make a new outline for Parameter B - Implementation
                                                        </DialogDescription>
                                                    </DialogHeader>
                                                    <div className=" flex flex-col gap-4">
                                                        <div>
                                            ...
                                            <Dialog>
                                                ...
                                                <DialogContent>
                                                    <DialogHeader>
                                                        <DialogTitle>Add Outline</DialogTitle>
                                                        <DialogDescription>
                                                            Make a new outline for Parameter B - Outcome
                                                        </DialogDescription>
                                                    </DialogHeader>
                                                    <div className=" flex flex-col gap-4">
                                                        <div>

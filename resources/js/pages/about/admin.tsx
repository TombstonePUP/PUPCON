        ...
        <>
            ...
            <Layout>
                <div className="flex flex-col items-center">
                    <PageHeader
                        title="University Adminstration"
                        breadcrumbs={[
                            { label: 'Home', href: '/' },
                        ...
                        <article className="admin-main">
                            ...
                            <section className="admin-card mb-12 rounded-xl border border-[#7f1414]/25 bg-white p-8">
                                ...
                                <p className="text-lg leading-relaxed text-gray-700">
                                    Governance of <strong>PUP</strong> is vested upon the <strong>Board of Regents</strong>, which exercises
                                    policy-making functions to carry out the mission and programs of the University by virtue of{' '}

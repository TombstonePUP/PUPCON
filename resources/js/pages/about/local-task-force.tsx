        ...
        <div className="flex flex-col items-center">
          ...
          <div className="relative z-10 mt-7 flex h-[10vw] w-[75%] items-center justify-center overflow-hidden rounded-xl">
            ...
            <div className="relative z-10 px-8 text-center text-white">
              <h1 className="text-6xl font-bold">Local Task Force</h1>
              <h2 className="mt-2">
              ...
              >
                ...
                <div className="space-y-6 text-lg leading-relaxed text-gray-700">
                  <p className="text-xl font-semibold text-gray-800">
                    Currently, there is no Local Task Force established yet.
                  </p>
                  <p>
                    The Local Task Force will be organized and appointed during the next accreditation cycle as part of
                    our continuous commitment to academic excellence and quality assurance.
                  </p>
                  <p>
                    This specialized committee will play a crucial role in supporting the accreditation process,
                    ensuring compliance with academic standards, and facilitating institutional improvement initiatives.
                  </p>
                </div>
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                >
                  ...
                  <p className="text-gray-600">
                    A specialized committee composed of faculty and staff members who support the accreditation process
                    and ensure institutional compliance with academic standards.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    To facilitate quality assurance processes, coordinate accreditation activities, and drive
                    institutional improvements aligned with educational excellence standards.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="text-gray-600">
                    The Local Task Force will be established during our upcoming accreditation preparations, ensuring
                    our campus maintains the highest standards of academic quality.
                  </p>
                </motion.div>
              </div>
            </section>

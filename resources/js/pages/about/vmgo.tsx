            ...
            <Layout>
                <div className="flex flex-col items-center">
                    ...
                    <article className="mission-vision-page mt-8 w-[75%]">
                        <div className="mb-2 rounded-xl rounded-b-none border border-[#7f1414]/25 bg-white p-8 duration-300 hover:border-[#7f1414]">
                            ...
                            <p className="mb-4 leading-relaxed text-gray-700">
                                The stellar accomplishments of the PUP San Juan Branch is ably founded on the University's vision: first as an
                                epistemic community towards a National Polytechnic University of the Philippines. In an effort to get there, the
                                Program is also strongly supporting the mission and development agenda of the University Leadership. What started as
                                an Eight-Point Development Plan under former University President Dr. Emanuel De Guzman was expanded and fortified by
                                the 10 Pillar Reform Agenda of current President, Dr. Manuel Muhi.
                            </p>
                            <p className="text-lg leading-relaxed text-gray-700" id="description">
                                The video below developed by the PUP Communication Management Office (CMO) briefly describes President Muhi's vision
                                for the University.
                            </p>
                        </div>
                        ...
                        <div className="flex gap-2">
                            ...
                            <section className="mb-8">
                                <div className="header-wrapper">
                                    <div className="section-header rounded-bl-xl border border-[#7f1414]/25 bg-white p-8 duration-300 hover:border-[#7f1414]">
                            ...
                            <section className="mb-8">
                                <div className="header-wrapper">
                                    <div className="section-header rounded-t-none rounded-br-xl border border-[#7f1414]/25 bg-white p-8 duration-300 hover:border-[#7f1414]">
                                        <div className="header-box mb-4">
                        ...
                        <section className="relative mb-12 overflow-hidden rounded-lg">
                            ...
                            {/* Gradient Overlay */}
                            <div className="absolute inset-0 z-10 bg-gradient-to-l from-white/90 via-white/60 to-transparent"></div>
                            ...
                            <div className="relative z-20 flex flex-col gap-8 p-8 lg:flex-row lg:items-center">
                                ...
                                <div className="map-right lg:w-1/3">
                                    ...
                                    <motion.p
                                        className="fade-in mb-4 text-xl font-semibold text-gray-800 delay-1"
                                        initial={{ opacity: 0, y: 20 }}
                                        animate={{ opacity: 1, y: 0 }}
                                    ...
                                    <motion.p
                                        className="fade-in tag mb-6 text-gray-600 italic delay-2"
                                        initial={{ opacity: 0, y: 20 }}
                                        animate={{ opacity: 1, y: 0 }}
                                        transition={{ delay: 0.75 }}
                                    >
                                        Discover the roadmap that shapes our future — goals, strategies, and developments leading PUP into a new era
                                        of excellence.
                                    </motion.p>
                                    <motion.a
                        ...
                        <section className="mb-8">
                            <div className="header-wrapper rounded-xl border border-[#7f1414]/25 bg-white p-6 duration-300 hover:border-[#7f1414]">
                        ...
                        <section className="template-statement mb-8">
                            <div className="header-wrapper">
                                <div className="section-header rounded-xl border border-[#7f1414]/25 bg-white p-8 duration-300 hover:border-[#7f1414]">
                                    <div className="header-box mb-6 inline-block w-full rounded-lg bg-[#7f1414] px-8 py-4">
                                        <h2 className="m-0 text-center text-3xl font-bold text-gray-100">PUP San Juan Goals</h2>
                                    </div>
                                    <div className="goals-list space-y-6">
                                        <div className="goal-item rounded-lg border-l-4 border-[#7f1414] bg-gray-50 p-6">
                                            ...
                                            <p className="text-gray-600 italic">
                                                <em>
                                                    Adhikain 1: Kahusayang Pang-Akademiko – Upang itaguyod at palakasin ang kahusayang pang-akademiko
                                                    upang magluwal ng mga propesyunal na mayroong pandaigdigang kakayahan, may kapanagutang
                                                    sosyo-ekonomikal, pangkultural at pangkasariang pagbuo.
                                                </em>
                                            </p>
                                        </div>

                                        <div className="goal-item rounded-lg border-l-4 border-[#7f1414] bg-gray-50 p-6">
                                            <h3 className="mb-3 text-xl font-bold text-[#7f1414]">Goal 2: Empowered Faculty Members and Employees</h3>
                                            <p className="mb-4 text-gray-700">
                                                To uplift the knowledge, skills, values and wellness of faculty members and employees through relevant
                                                capacity building by intensifying partnership with government agencies, private institutions, and
                                                individuals.
                                            </p>
                                            <p className="text-gray-600 italic">
                                                <em>
                                                    Adhikain 2: Pinahusay na Dalubguro at Kawani – Upang magpapaunlad ng karunungan, kasanayan,
                                                    kahalagahan at kalusugan ng mga dalubguro at mga kawani sa pamamagitan ng mga makabuluhang gawaing
                                                    magpapatibay ng ugnayan sa mga sangay ng pamahalaan, pribadong institusyon at mga indibidwal.
                                                </em>
                                            </p>
                                        </div>

                                        <div className="goal-item rounded-lg border-l-4 border-[#7f1414] bg-gray-50 p-6">
                                            <h3 className="mb-3 text-xl font-bold text-[#7f1414]">Goal 3: Commitment in Research Engagement</h3>
                                            <p className="mb-4 text-gray-700">
                                                To produce interdisciplinary and multidisciplinary researches through collaboration and linkages for
                                                generating new knowledge and addressing societal needs.
                                            </p>
                                            <p className="text-gray-600 italic">
                                                <em>
                                        ...
                                        <div className="goal-item rounded-lg border-l-4 border-[#7f1414] bg-gray-50 p-6">
                                            ...
                                            <p className="text-gray-600 italic">
                                                <em>
                                                    ...
                                                    Upang makapag-ambag sa pagpapabuti ng pamayanan sa pamamagitan ng pagpapatupad ng mga programang
                                                    pantulong at pang-ugnayang panlabas na batay sa mga katibayan.
                                                </em>
                                            </p>
                                        </div>

                                        <div className="goal-item rounded-lg border-l-4 border-[#7f1414] bg-gray-50 p-6">
                                            <h3 className="mb-3 text-xl font-bold text-[#7f1414]">Goal 5: State-of-the-art Knowledge Management</h3>
                                            <p className="mb-4 text-gray-700">
                                                To upgrade facilities, equipment, and other educational resources conducive for dynamic and holistic
                                                learning.
                                            </p>
                                            <p className="text-gray-600 italic">
                                                <em>
                                        ...
                                        <div className="goal-item rounded-lg border-l-4 border-[#7f1414] bg-gray-50 p-6">
                                            ...
                                            <p className="text-gray-600 italic">
                                                <em>
                                                    Adhikain 6: Matatag na Akademikong Pamayanan – Upang bumuo ng isang matatag, ligtas at matibay na
                                                    akademikong komunidad na nakasandig sa mga pagpapahalagang Pilipino upang masuportahan ang mga
                                                    pag-unlad at oportunidad sa pamamagitan ng pakikipagkapwa at aktibong pakikipag-ugnayan.
                                                </em>
                                            </p>
                                        </div>
                                    </div>

        ...
        <div className="flex flex-col items-center">
          ...
          <div className="relative z-10 mt-7 flex h-[10vw] w-[75%] items-center justify-center overflow-hidden rounded-xl">
            ...
            <div className="relative z-10 px-8 text-center text-white">
              <h1 className="text-6xl font-bold">Facilities</h1>
              <h2 className="mt-2">
              ...
              <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                {facilities.map((facility, index) => (
                  ...
                  >
                    {/* Card Front */}
                    <div
                      className={`card-front transition-all duration-500 ${hoveredCard === facility.id ? "opacity-0 scale-95" : "opacity-100 scale-100"}`}
                    >
                      ...
                      <div className="p-6">
                        <h3 className="mb-3 text-2xl font-bold text-[#7f1414] group-hover:text-[#a01818]">
                          {facility.name}
                        </h3>
                    ...
                    {/* Card Back */}
                    <div
                      className={`card-back absolute inset-0 bg-gradient-to-br from-[#7f1414] to-[#a01818] p-6 text-white transition-all duration-500 ${hoveredCard === facility.id ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}
                    >

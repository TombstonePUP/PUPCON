      ...
      <SettingsLayout>
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-5 gap-3">
            <div className="bg-white border rounded-lg p-3 text-center">
              <div className="flex items-center justify-center mb-1">
                <FileText className="h-4 w-4 text-[#7f1414] mr-1" />
            ...
            <div className="bg-white border rounded-lg p-3 text-center">
              <div className="flex items-center justify-center mb-1">
                <BookOpen className="h-4 w-4 text-[#7f1414] mr-1" />
            ...
            <div className="bg-white border rounded-lg p-3 text-center">
              <div className="flex items-center justify-center mb-1">
                <ImageIcon className="h-4 w-4 text-[#7f1414] mr-1" />
            ...
            <div className="bg-white border rounded-lg p-3 text-center">
              <div className="flex items-center justify-center mb-1">
                <Users className="h-4 w-4 text-[#7f1414] mr-1" />
            ...
            <div className="bg-white border rounded-lg p-3 text-center">
              <div className="flex items-center justify-center mb-1">
                <Archive className="h-4 w-4 text-[#7f1414] mr-1" />
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#7f1414] focus:border-transparent"
                />
              </div>
          ...
          {selectedItems.length > 0 && (
            <div className="bg-[#7f1414]/5 border border-[#7f1414]/20 rounded-lg p-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className="h-8 text-green-700 border-green-300 hover:bg-green-50 bg-transparent"
                  >
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button
                        variant="outline"
                        size="sm"
                        className="h-8 text-red-700 border-red-300 hover:bg-red-50 bg-transparent"
                      >
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    {archivedItems.documents.map((doc) => (
                      <div
                        key={doc.id}
                        className="flex items-center gap-3 p-2 border rounded-lg hover:bg-gray-50 group"
                      >
                        <input
                          type="checkbox"
                          checked={selectedItems.includes(doc.id)}
                          onChange={() => handleSelectItem(doc.id)}
                          className="h-4 w-4 text-[#7f1414] focus:ring-[#7f1414] border-gray-300 rounded"
                        />
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 text-xs text-gray-500 mt-1">
                            ...
                            <span className="bg-gray-100 px-1.5 py-0.5 rounded text-xs">{doc.category}</span>
                    ...
                    {archivedItems.programs.map((program) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 text-xs text-gray-500 mt-1">
                            <span className="bg-[#7f1414]/10 text-[#7f1414] px-1.5 py-0.5 rounded text-xs font-medium">
                              {program.degreeType}
                            </span>

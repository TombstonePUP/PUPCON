...
export const frequencyDummyUploads: FrequencyUploads[] = Array.from({ length: 90 }, (_, i) => {
    ...
    return {
        ...
        upload_count: Math.floor(Math.random() * 20) + 1,
    };
});
...
export const activityDummyLogs: ActivityLogs[] = [
    {
        ...
        description: 'Uploaded Budget Report Q1',
        activity: 'Upload',
    ...
    },
    {
        ...
        description: 'Approved Curriculum Map v2',
        activity: 'Approve',
    ...
    },
    {
        ...
        description: 'Rejected Exhibit A submission',
        activity: 'Reject',
        type: 'File Management',
        activity_date: '2025-03-27',
    },
    {
        ...
        description: 'Uploaded Faculty Load Form',
        activity: 'Upload',
        type: 'File Management',
    ...
    },
    {
        ...
        description: 'Uploaded Accreditation Checklist',
        activity: 'Upload',
        type: 'Content Management',
    ...
    },
    {
        ...
        description: 'Approved Research Output Exhibit',
        activity: 'Approve',
        type: 'Content Management',
        activity_date: '2025-03-25',
    },
    {
        ...
        description: 'Updated Syllabus Form',
        activity: 'Update',
    ...
    },
    {
        ...
        description: 'Uploaded Extension Program Docs',
        activity: 'Upload',
        type: 'File Management',
    ...
    },
    {
        ...
        description: 'Rejected Incomplete Exhibit C',
        activity: 'Reject',
        type: 'User Management',
    ...
    {
        activity_log_id: 10,
        full_name: 'Donna Mercado',
        description: 'Approved Faculty Profile Forms',
        activity: 'Approve',
        type: 'User Management',

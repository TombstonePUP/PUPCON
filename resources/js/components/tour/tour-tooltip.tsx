    ...
    >
      ...
      <div className="p-6">
        <div className="mb-2 flex items-center justify-between">
          ...
          <button onClick={stopTour} className="rounded-full p-1 text-gray-400 hover:bg-gray-100 hover:text-[#7f1414] transition-colors">
            <X size={18} />
          </button>
        </div>
        ...
        <div className="mt-8 flex items-center justify-end gap-3">
          ...
          <Button 
            ...
            className="rounded-xl bg-[#7f1414] text-white hover:bg-[#9b1c1c] shadow-none border-none px-6 font-bold"
          >
            {isLast ? 'Finish' : 'Next'}
          </Button>
        </div>

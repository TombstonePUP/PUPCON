  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-4xl">
        <DialogHeader>
          <DialogTitle className="mb-4 text-lg font-medium text-foreground">{type === 'edit' ? 'Edit Area' : 'Add New Area'}</DialogTitle>
          <DialogDescription className="flex flex-col text-sm text-muted-foreground">

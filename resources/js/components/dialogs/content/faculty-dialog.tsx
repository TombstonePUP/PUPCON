...
export function FacultyDialog({ ...props }: FacultyDialogProps) {
    ...
    return (
        <Dialog open={true} onOpenChange={onClose}>
            <DialogContent className="w-3xl sm:max-w-3xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                ...
                <div className="mt-6 max-h-sm ">
                    <div className='flex gap-8'>
                        ...
                        <div className='flex flex-col gap-4 w-[50%]'>
                            {!data.previewUrl ? (
                                ...
                                <div className="group relative">
                                    <img src={data.previewUrl} alt="Preview" className="h-36 w-full rounded-lg border border-gray-200 object-cover" />
                            ...
                            <div>
                                <Label className="mb-2 block text-sm font-medium text-gray-700 w-full">First Name</Label>
                                <Input
                        ...
                        <div className="flex flex-col gap-4 w-[50%] pb-0 mb-0">
                            ...
                            <div>
                                ...
                                <Select value={data.personnel_type || ''} onValueChange={(value) => setData((prev) => ({ ...prev, personnel_type: value }))}>

...
export function FacilitiesDialog({ facility, type, onSave, onClose }: FacilitiesDialogProps) {
    const [data, setData] = useState<FacilityForm>({
        ...
        facility_image: null,
        previewUrl: facility?.facility_image_path || null,
    });
            ...
            <DialogContent className="w-full max-w-lg">
                <DialogHeader>
                    <DialogTitle className="text-lg font-medium text-gray-900">
                        {type === 'edit' ? 'Edit Facility' : 'Add Facility'}
                    </DialogTitle>
                    <DialogDescription className="text-sm text-gray-500">
                        {type === 'edit'
                            ? `Modify the details of "${facility?.facility_name}".`
                ...
                <div className="max-h-[70vh] space-y-4 overflow-y-auto pr-2">
                    <div>
                        {!data.previewUrl ? (
                            ...
                            <div className="relative group">
                                ...
                                />
                                <div className="rounded-lg absolute inset-0 flex items-center justify-center bg-black/40 opacity-0 transition group-hover:opacity-100">
                                    <Button
                                        type="button"
                                        variant="outline"
                                        size="sm"
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setData({ ...data, facility_name: e.target.value })
                            }
                        />
                    </div>

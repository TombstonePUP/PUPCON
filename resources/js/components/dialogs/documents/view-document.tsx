  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={`!max-w-none ${dialogSize} flex flex-col gap-0 bg-slate-50 p-0 [&>button]:hidden border-none`}>
        <DialogHeader className="rounded-t-lg text-lg font-medium text-foreground bg-primary text-white">
          <div className="flex items-center justify-between gap-0 p-4 pl-6">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <Button
                className="bg-primary-foreground text-primary hover:scale-105 hover:bg-primary-foreground/80"
                size="sm"
                onClick={zoomOut}
                title="Zoom Out"

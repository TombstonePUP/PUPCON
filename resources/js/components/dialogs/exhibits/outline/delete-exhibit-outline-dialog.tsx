...
export default function DeleteExhibitOutlineDialog({ outline, onClose }: DeleteExhibitOutlineDialogProps) {
    const { data, delete: destroy, processing, errors, reset } = useForm<{outline_id: number;}>({
            ...
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription className="mt-4 mb-6 text-sm text-gray-500">
                        Are you sure you want to delete the outline "{outline.outline_description}"? This action will aslo remove the associated file from the system and cannot be undone.
                    </DialogDescription>
                    <DialogFooter>
                        <DialogClose asChild>
                            <Button

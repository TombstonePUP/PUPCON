      ...
      <DialogContent>
        ...
        <form onSubmit={importParameter} className="flex flex-col gap-10">
          <div className="space-y-2">
            <div className="w-full rounded-lg border border-border p-6 text-left">
              <h3 className="mb-2 text-xs font-semibold tracking-wide text-muted-foreground uppercase">How to use</h3>
              <ol className="list-inside list-decimal space-y-1 text-sm text-muted-foreground">
                ...
                <li>Open in <span className="font-medium text-foreground">Excel</span> or Google Sheets.</li>
                <li>Fill in your data (keep headers intact).</li>
                <li><span className="font-medium text-foreground">Save</span> and upload the file.</li>
              </ol>
            </div>

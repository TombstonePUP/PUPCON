...
export default function Parameter({ areaId, program, areaParameters, parameterOutlineCategories}: ParameterProps) {
    ...
    const addParameter = (e: React.FormEvent) => {
        e.preventDefault();
        postParams(route('manage.area.addParameter', [
            program,
            areaId
        ]), {
            onFinish: () => {
    ...
    const deleteOutline = (id: number) => {
        console.log(id);
        destroyOutline(route('manage.area.deleteOutline', [
            program,
            areaId,
            id,
        ]), {
                                                                ...
                                                                <Dialog>
                                                                    ...
                                                                    <DialogContent>
                                                                        <DialogHeader>
                                                                            <DialogTitle>Are you sure?</DialogTitle>
                                                                            <DialogDescription>
                                                                                This action cannot be undone. This will permanently delete the <b>{outline.outline_description} and its corresponding document</b>.
                                                                            </DialogDescription>
                                                                        </DialogHeader>
                                                                        <DialogFooter>
                                                                            <DialogClose asChild>
                                                                            ...
                                                                            <Button disabled={processingOutline} onClick={() =>deleteOutline(outline.parameter_outline_id)}
                                                                                type="submit">
                                                                                Remove
                                                                            </Button>
                                                                        </DialogFooter>

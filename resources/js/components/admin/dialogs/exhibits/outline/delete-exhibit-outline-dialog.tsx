        ...
        <Dialog open={true} onOpenChange={() => onClose()}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription className="text-muted-foreground mt-4 mb-6 text-sm">
                        Are you sure you want to delete the content of "{outline.outline_description}"? This action will aslo remove the associated
                        file from the system and cannot be undone.
                    </DialogDescription>
                    <DialogFooter>
                        <DialogClose asChild>

    ...
    return (
        <Dialog open={true} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-4xl">
                <DialogHeader>
                    <DialogTitle className="text-foreground mb-4 text-lg font-medium">{type === 'edit' ? 'Edit Area' : 'Add New Area'}</DialogTitle>
                    <DialogDescription className="text-muted-foreground flex flex-col text-sm">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5 space-y-4">
                    <div className="flex gap-8">
                        {!data.previewUrl ? (
                            ...
                            <div className="group relative w-[50%]">
                                <img
                                    src={data.previewUrl}
                                    alt="Preview"
                                    className="h-full w-full rounded-lg border border-gray-200 object-cover transition-all"
                                />
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div>
                                <Label className="text-foreground mb-2 block text-sm font-medium">
                                    Area Description <span className="text-red-500">*</span>
                                </Label>
                                <Textarea

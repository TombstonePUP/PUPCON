    ...
    return (
        <Dialog open={true} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle className="text-foreground text-lg font-medium">{type === 'edit' ? 'Edit Program' : 'Add New Program'}</DialogTitle>
                            ...
                            <div className="grid grid-cols-6 gap-2 sm:grid-cols-11">
                                {availableColors.map((color) => (
                                    <button
                                        ...
                                        disabled={processing}
                                        className={`relative size-7 rounded transition-all hover:scale-110 focus:ring-2 focus:ring-[#7f1414] focus:ring-offset-2 focus:outline-none ${
                                            colorClasses[color]

    ...
    return (
        <SidebarGroup>
            ...
            <SidebarMenu>
                {items.map((item) =>
                    item.collapsible ? (
                        <Collapsible key={item.title} asChild defaultOpen={item.isActive || hasActiveChild(item.items)} className="group/collapsible">
                            <SidebarMenuItem>
                                        ...
                                        {item.items?.map((subItem) => (
                                            <SidebarMenuSubItem key={subItem.title}>
                                                <SidebarMenuSubButton asChild isActive={isActive(subItem.url)}>
                                                    <Link href={subItem.url} className="flex justify-between capitalize hover:cursor-pointer">
                        ...
                        <SidebarMenuItem key={item.title}>
                            <SidebarMenuButton tooltip={item.title} asChild isActive={isExactActive(item.url)} className="hover:cursor-pointer">

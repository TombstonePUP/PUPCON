            ...
            <div className="flex items-center gap-3 py-4">
                ...
                <TabsList>
                    <TabsTrigger value="active" onClick={() => setTab('active')}>
                        Active
                        <Badge variant="secondary">{data.filter((d) => d.is_active).length}</Badge>
                    </TabsTrigger>
            ...
            <div className="flex items-center gap-3 py-4">
                ...
                <TabsList>
                    <TabsTrigger value="document" onClick={() => setTab('document')}>
                        Documents <Badge variant="secondary">{data.filter((d) => d.log_type === 'Document').length}</Badge>
                    </TabsTrigger>
                    <TabsTrigger value="content" onClick={() => setTab('content')}>
                        Content <Badge variant="secondary">{data.filter((d) => d.log_type === 'Content').length}</Badge>
                    </TabsTrigger>
                </TabsList>
                <DataTableViewOptions table={table} />
            </div>

    ...
    <div className="mt-5 flex flex-col gap-3">
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-lg">
          ...
          <div className="py-2">
            <div
              className={`relative overflow-hidden rounded-xl border-2 border-dashed p-12 text-center transition-all duration-200 ${dragActive ? 'border-red-500 bg-red-50' : 'border-gray-300 bg-gray-50 hover:border-red-400'
                }`}

...
export default function Layout({ children, className }: LayoutProps) {
    ...
    const redirectLink = (outline: any) => {
        ...
        router.visit(`/programs/${program_id}/${areaId}?parameter=${parameterId}#outline-${outlineId}`, {
            preserveScroll: true,
            only: [],
            data: {
                outline: outlineId,
                ...
                <div className="relative mr-[10vw] max-w-7xl">
                    ...
                    <div className="hidden items-center justify-end gap-8 lg:flex">
                                ...
                                {[...leftNav, ...rightNav].map((item) => (
                                    <li key={item.label} className="group relative">
                                        ...
                                        {item.dropdown?.length > 0 && (
                                            <div className="w- absolute left-0 mt-[1vw] max-h-0 max-w-xs overflow-hidden rounded-md bg-white/85 p-1 text-sm opacity-0 backdrop-blur-lg transition-all duration-300 ease-out group-hover:max-h-96 group-hover:opacity-100">
                                                    ...
                                                    {item.dropdown.map((drop) => (
                                                        <li key={drop.label} className="border-b border-gray-100 last:border-none">
                                                            <div className="group/item rounded hover:bg-[#7f1414]/90">
                                                                <Link
                                                                    href={drop.href}
                                                                    className="flex items-center gap-2 px-2 py-3 pr-8 text-sm text-[#7f1414] transition-colors group-hover/item:text-white"
                                                                    preserveScroll
                                                                >
                        ...
                        <motion.button
                            ...
                            className="relative flex items-center justify-center rounded-full bg-white/10 text-white ring-1 ring-white/20 transition-all duration-200 hover:bg-white/20 hover:ring-white/40 focus:ring-2 focus:ring-white/60 focus:outline-none"
                            title="Search"
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            transition={{ duration: 0.2 }}
                        >
                            <Search className="m-[0.5vw] size-[1.25vw]" />
                        </motion.button>
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between border-b border-gray-200/50 bg-white/80 px-6 py-5 backdrop-blur-sm">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="ml-3 bg-[#7f1414] bg-clip-text text-xl font-bold text-transparent">Mabuhay!</h2>
                                </div>
                            ...
                            <div className="hide-scrollbar h-200 flex-1 overflow-scroll scroll-smooth">
                        ...
                        >
                            ...
                            <button onClick={() => toggleDropdown(item.label)} className="p-2">
                              ...
                              />
                                                ...
                                                {item.dropdown?.length > 0 && (
                                                    <div
                                                        className={cn('duration-300max-h-96 overflow-hidden bg-white text-[#7f1414] transition-all')}
                                                    >
                                                        <ul className="flex flex-col">
                                                            {item.dropdown.map((drop) => (
